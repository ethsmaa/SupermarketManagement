...
public class FileReaderDH {
    ...
    public void customerReadandParse(DoubleHashingHashTable hashMap) {
        try {
    ...
    public void searchAndPrint(String id, DoubleHashingHashTable hashMap) {
